...
const ReviewsSection = () => {
  ...
  const reviewsChunks = [];
  const numReviewsPerChunk = isMobile ? 1 : 3;
  ...
  return (
    <div className="reviews-section" style={{ backgroundImage: `url(${bgReviews})` }}>
      <h1 className="text-center" style={{ marginBottom: '50px', color: 'rgba(252, 89, 1, 0.7)', fontFamily: 'Outfit', fontWeight: 'bold', fontSize: '35px' }}>Customer Reviews</h1>
